...
const steps = [
  {
    ...
    description: "Mapeamento do fluxo atual, da planilha, da rotina e das regras que hoje travam a execução.",
  },
  {
    step: "02",
    title: "Estruturação lógica",
    description: "Transformação do processo em regras, validações, estrutura de dados e lógica operacional de sistema.",
  },
  {
    step: "03",
    title: "Construção do SaaS",
    description: "Aplicação online pronta para uso, com acesso centralizado, histórico e controle real da operação.",
  },
  {
    step: "04",
    title: "Operação contínua",
    description: "Evolução, ajustes e suporte para o sistema crescer junto com a complexidade do processo.",
  },
];
    ...
    <main className="min-h-screen overflow-x-hidden bg-[#F7F8FA] text-[#0F172A]">
                  ...
                  <div className="rounded-2xl border border-[#D0D5DD] bg-[#FCFCFD] p-5">
                    ...
                    <div className="mt-4 space-y-4">
                      {[
                        ...
                        ["Resultado operacional", "Mais velocidade, menos risco operacional"],
                      ].map(([label, value]) => (
              ...
              <div className="mt-4 rounded-[24px] border border-black/5 bg-[#F8FAFC] p-6 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  {["Você perde tempo", "Perde controle", "Perde escala"].map((item) => (
                    <div key={item} className="rounded-xl border border-black/5 bg-white px-4 py-3 text-sm font-medium text-[#101828]">{item}</div>
                  ))}
                </div>
              </div>
            </div>
      ...
      <section className="px-4 py-16 md:px-8 md:py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {features.map((item) => (
                <div key={item} className="rounded-2xl border border-black/5 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.05)]">
                  <div className="text-sm font-semibold uppercase tracking-[0.14em] text-[#98A2B3]">Capacidade</div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {["Menos operação manual", "Mais controle", "Mais velocidade"].map((item) => (
            ...
            <div className="grid gap-4">
              {proofItems.map((item, index) => (
                <div key={item} className="rounded-2xl border border-black/5 bg-[#F8FAFC] p-6">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#98A2B3]">Caso de uso {index + 1}</div>
                  <p className="mt-3 text-base leading-7 text-[#101828]">{item}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="para-quem" className="px-4 py-16 md:px-8 md:py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[0.88fr_1.12fr]">
            <div>
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#101828] md:text-5xl">Para quem sabe o processo, mas não quer mais operar no improviso.</h2>
            </div>
            <div className="grid gap-4">
              {audiences.map((item) => (
      ...
      <section className="border-y border-black/5 bg-white px-4 py-16 md:px-8 md:py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#101828] md:text-5xl">Não é software genérico. É software do seu processo.</h2>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
      ...
      <section className="px-4 py-16 md:px-8 md:py-24 lg:px-10">
        <div className="mx-auto max-w-7xl rounded-[32px] border border-black/5 bg-[#0F172A] px-6 py-8 text-white shadow-[0_24px_80px_rgba(15,23,42,0.18)] md:px-10 md:py-12">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            <div>
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-white md:text-5xl">Construído por quem entende operação de verdade</h2>
              <p className="mt-6 max-w-lg text-lg leading-8 text-white/72">O IronSaaS nasce dentro da IronCore. Ou seja: não é só tecnologia. É gestão aplicada. É experiência real de operação. E vive dentro do ecossistema principal da IronCore em ironcore.lat.</p>
            </div>
            <div className="grid gap-4">
              {[
                "Não é só tecnologia",
      ...
      <section className="border-y border-black/5 bg-[#FCFCFD] px-4 py-16 md:px-8 md:py-24 lg:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              <h2 className="text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#101828] md:text-5xl">Isso substitui meu ERP?</h2>
            </div>
            <div className="rounded-[28px] border border-black/5 bg-white p-8 shadow-[0_24px_80px_rgba(15,23,42,0.08)]">
              <p className="text-lg leading-8 text-[#475467]">Não. O IronSaaS complementa o que você já tem. Ele resolve exatamente aquilo que o ERP não resolve: a operação real, o controle fino e o fluxo do dia a dia.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          <div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {[
                "Conversa objetiva sobre o processo",
                "Avaliação rápida de aderência",
                "Sem compromisso técnico prévio",
                "Próximo passo claro para demo",
              ].map((item) => (
                <div key={item} className="rounded-2xl bg-[#F8FAFC] p-5 text-sm leading-7 text-[#101828]">{item}</div>
              ))}
            </div>
          </div>
