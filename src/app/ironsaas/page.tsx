                ...
                <div className="mt-5 grid gap-4 lg:grid-cols-[0.88fr_1.12fr]">
                  <div className="rounded-2xl border border-[#D0D5DD] bg-[#FCFCFD] p-5">
                    ...
                    <div className="mt-4 space-y-4">
                      {[["Antes", "Planilhas, retrabalho e controles soltos"], ["Depois", "Sistema único com lógica e validações"], ["Impacto", "Mais velocidade, menos risco operacional"]].map(([label, value]) => (
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-10">
          <div className="rounded-[32px] border border-black/5 bg-[#F8FAFC] px-6 py-8 md:px-10 md:py-12">
            ...
            <div className="mt-6 grid gap-8 lg:grid-cols-2">
              <div><div className="text-sm font-semibold uppercase tracking-[0.18em] text-[#98A2B3]">Você não é</div><div className="mt-4 space-y-3 text-lg leading-8 text-[#667085]"><p>❌ software house</p><p>❌ fábrica de sistema</p><p>❌ SaaS genérico</p></div></div>
              <div><div className="text-sm font-semibold uppercase tracking-[0.18em] text-[#98A2B3]">Você é</div><div className="mt-4 text-2xl font-semibold leading-tight tracking-[-0.03em] text-[#101828]">👉 transformador de operação em sistema escalável</div></div>
            </div>
          </div>
        </div>
      </section>
